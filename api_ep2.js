...
const MMA_EP2_API_CONFIG = {
  ...
  LEGAL_CODES: {
    STUDY_WORK_PROTECTION: {
      lawName: "예비군법 제10조의2(직장 보장) 및 제10조의3(학업 보장)",
      clause1: "제10조의3(학업 보장): 고등학교 이상의 학교의 장은 학생이 예비군 훈련에 참가한 기간을 결석으로 처리하거나 불리하게 처우하지 못한다.",
      clause2: "제10조의2(직장 보장): 고용주는 근로자가 예비군 훈련을 받는 기간을 유급으로 처리하여야 하며, 휴무나 결근 등 불리한 처우를 하지 못한다.",
